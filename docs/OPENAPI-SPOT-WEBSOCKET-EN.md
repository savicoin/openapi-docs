# Savicoin WebSocket API Documentation

## 1. WebSocket Overview

Savicoin Trading Platform provides WebSocket interfaces that support real-time subscription to market data and user data, offering lower latency and higher efficiency compared to REST API. WebSocket connections do not require authentication, but subscribing to private user data requires an authentication token.
