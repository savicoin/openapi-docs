...
public class OrderCreateTest {
     ...
     */
    private void testSellBtcOrder() throws SavicoinApiException {
        // 执行卖出操作（使用市价单）
     ...
     */
    public String createOrder(OrderRequest orderRequest) throws SavicoinApiException {
        try {
            // 参数校验
    ...
    public String sellBtcForUsdt(BigDecimal btcAmount, BigDecimal btcPrice, boolean isMarketOrder)
        ...
        try {
            ...
            throw new SavicoinApiException("卖出BTC时出错: " + e.getMessage(), e);
        }
    }
    ...
    public String buyBtcWithUsdt(BigDecimal btcAmount, BigDecimal btcPrice, boolean isMarketOrder)
        ...
        try {
            ...
            throw new SavicoinApiException("买入BTC时出错: " + e.getMessage(), e);
        }
    }
     ...
     * 测试场景：买入BTC
     */
    private void testBuyBtcOrder() throws SavicoinApiException {
        log.info("===== 买入BTC测试 =====");
