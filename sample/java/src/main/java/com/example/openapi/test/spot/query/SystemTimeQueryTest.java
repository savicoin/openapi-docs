...
public class SystemTimeQueryTest {
     ...
     */
    public Long getSystemTime() throws SavicoinApiException {
        try {
            ...
            if (apiResponse.getCode() != 0) {
                throw new SavicoinApiException("获取系统时间失败: " + apiResponse.getMsg());
            }
            ...
            throw new SavicoinApiException("获取系统时间时出错: " + e.getMessage(), e);
        }
    }
     ...
     * 测试获取系统时间
     */
    private void testGetSystemTime() throws SavicoinApiException {
        log.info("===== 获取系统时间测试 =====");
