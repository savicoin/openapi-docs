...
public class OrderQueryTest {
     ...
     */
    public OrderVO getOrderDetail(Long orderId) throws SavicoinApiException {
        try {
            // 验证参数
            ...
            if (!apiResponse.isSuccess()) {
                throw new SavicoinApiException("查询订单失败: " + apiResponse.getMsg());
            }
            ...
            throw new SavicoinApiException("查询订单时出错: " + e.getMessage(), e);
        }
    }
     ...
     * 测试查询订单详情
     */
    private void testQueryOrderDetail() throws SavicoinApiException {
        log.info("===== 测试查询订单详情 =====");
