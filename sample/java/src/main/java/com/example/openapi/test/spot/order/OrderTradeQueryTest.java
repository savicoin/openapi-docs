...
public class OrderTradeQueryTest {
    ...
    public PageResult<OrderTradeVO> getOrderTrades(
        ...
        try {
            ...
            if (apiResponse.getCode() != 0) {
                throw new SavicoinApiException("查询成交明细失败: " + apiResponse.getMsg());
            }
            ...
            throw new SavicoinApiException("查询成交明细时出错: " + e.getMessage(), e);
        }
    }
     ...
     * 测试查询指定订单的成交明细
     */
    private void testQueryTradesByOrderId() throws SavicoinApiException {
     ...
     * 测试查询指定交易对的成交明细
     */
    private void testQueryTradesBySymbol() throws SavicoinApiException {
