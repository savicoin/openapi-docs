...
public class AllTickersQueryTest {
     ...
     */
    public List<TickerVO> getAllTickersData() throws SavicoinApiException {
        try {
            ...
            if (!apiResponse.isSuccess()) {
                throw new SavicoinApiException("获取全交易对Ticker数据失败: " + apiResponse.getMsg());
            }
            ...
            throw new SavicoinApiException("获取全交易对Ticker数据时出错: " + e.getMessage(), e);
        }
    }
     ...
     * 测试获取全交易对的ticker数据
     */
    private void testGetAllTickersData() throws SavicoinApiException {
